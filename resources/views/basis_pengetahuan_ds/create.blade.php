    ...
    <form action="{{ route('basis_pengetahuan_ds.store') }}" method="POST">
        ...
        <div class="gejala-section">
            <div class="section-label">
                Gejala & Bobot DS (Dempster-Shafer)
            </div>
            ...
            <div id="gejala-wrapper">
                ...
                <div class="gejala-row">
                    ...
                    <select name="gejalas[0][ds_value]" class="ds-select" required>
        ...
        <div class="btn-actions">
            ...
            <a href="{{ route('basis_pengetahuan_ds.index') }}" class="btn-back">Kembali</a>
        </div>
    </form>
</div>


{{-- Script Disable Duplicate Gejala --}}
<script>
...
function tambahGejala() {
    ...
    <div class="gejala-row">
        ...
        <select name="gejalas[${index}][ds_value]" class="ds-select" required>
            <option value="">-- Bobot DS --</option>
            <option value="0.1">0.1</option>
            <option value="0.2">0.2</option>
            <option value="0.3">0.3</option>
