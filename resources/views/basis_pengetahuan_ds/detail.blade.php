{{-- resources/views/basis_pengetahuan_ds/detailPenyakitDS.blade.php --}}
@extends('layouts.app')
...
<div class="form-card">
    ...
    @php
         ...
         * $usedBasisDSIds = [..id basis_pengetahuan_ds yang tidak boleh dihapus..]
         * contoh: karena sudah dipakai di diagnosa/riwayat/dll
         */
        $usedBasisDSIds = $usedBasisDSIds ?? [];
    @endphp
    ...
    <div class="table-wrap">
        <table class="table">
            ...
            @forelse($rules as $i => $row)
                @php
                    $isUsed = in_array($row->id, $usedBasisDSIds, true);
                @endphp
                    ...
                    <td style="text-align:center;">
                        <div class="action-group">
                            ...
                            <form id="delete-form-{{ $row->id }}"
                                  action="{{ route('basis_pengetahuan_ds.destroy', $row->id) }}"
                                  method="POST"
                                  style="display:none;">
                                @csrf
                                @method('DELETE')
...
<div id="deleteConfirmModal" class="modal-overlay" aria-hidden="true">
    <div class="modal-box" role="dialog" aria-modal="true" aria-labelledby="deleteConfirmTitle">
        ...
        <p>Apakah Anda yakin ingin menghapus data basis DS ini?</p>
